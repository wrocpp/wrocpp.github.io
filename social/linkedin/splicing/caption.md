...
This is part 3 of the wro.cpp reflection series. Posts 2 + 3 give you the two halves; <PostLink slug="template-for-expansion-statements">post 4</PostLink> adds the loop primitive (`template for`) and the post-1 JSON-serializer teaser stops being a teaser.
