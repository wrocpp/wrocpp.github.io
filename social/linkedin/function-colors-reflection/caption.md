...
## Body
"What color is your function?" has been a complaint about async/await for a decade -- the way it splits a codebase into red (async) and blue (sync) halves that cannot freely call each other.
