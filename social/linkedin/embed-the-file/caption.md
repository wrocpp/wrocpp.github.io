...
xxd -i produced an artifact that could silently drift from the file it came from. #embed has no intermediate: the file is the source of truth, read fresh on every build. GCC 16.1 ships it today.
