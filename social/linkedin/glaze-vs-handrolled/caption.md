...
## Body
On 28 April Stephen Berry shipped Glaze v7.2 -- the first release whose reflection backend is standard C++26, not __PRETTY_FUNCTION__ string-scraping.
...
Reflection retired the macro tax on every JSON library at once -- and made the thirty-line teaching version a real artefact you can ship.
