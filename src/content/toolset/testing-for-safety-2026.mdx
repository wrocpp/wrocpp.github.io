...
Full file: <RepoFile path="posts/toolset/testing-for-safety-2026/examples/reflect-arbitrary.cpp" branch="main" />. (Godbolt embed regenerates on the next `shorten-examples.py` run.)
...
<DockerRun
  ...
  title="arbitrary<T> + round-trip property tests, locally on cpp-reflection"
/>
...
<DockerRun
  ...
  title="pretty_diff field-level test failure diagnostics"
/>
