...
draft: false
discussion: https://github.com/wrocpp/wrocpp.github.io/discussions/55
---
...
Autoincrement PKs skipped via `if constexpr (continue)`. The compiled function has no generated code and no runtime branch for them.
...
- **Session / transaction management.** A real ORM wraps `sqlite3_stmt*` in a session that batches, caches, and rolls back on error. This is orthogonal to reflection, so you bolt it on separately.
...
<GodboltEmbed id="jWoYKK9Wo" title="reflect_orm — struct → SQL" />

## Next reflection recipes in the series

- **[Post 14: Autowired dependency injection](/posts/dependency-injection/)** reflects constructor parameters.
- **[Post 15: Auto-generated mocks](/posts/auto-mocks/)** turns an interface into a test double.
