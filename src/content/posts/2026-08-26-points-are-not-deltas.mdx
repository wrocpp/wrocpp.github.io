...
This is the third post in the run of well-typed numbers that are still wrong, after <PostLink slug="unit-bug-mars-orbiter">wrong units</PostLink> and <PostLink slug="quantity-kinds">wrong kinds</PostLink>.
