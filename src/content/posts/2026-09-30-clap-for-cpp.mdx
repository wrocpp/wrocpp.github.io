...
- Compile-time validation. Forgetting to handle a field is a compile error, so you'll know before shipping, not at runtime when a user passes `--missing-flag`.
