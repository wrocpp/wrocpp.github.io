...
summary: "GCC 16.2 shipped on 7 August with more than a hundred regression fixes and no new features. LLVM 23.1 is still at its second release candidate. MSVC has no C++26 date. If you want to write C++26 today, the practical answer remains GCC, and this is where each toolchain actually stands."
draft: false
...
A pure bug-fix release from the GCC 16 branch: **more than a hundred regressions fixed** against 16.1, no new language or library features. Richard Biener announced it, and it is expected to become the default compiler in Ubuntu 26.10 and Fedora 45, which matters more than the changelog does since it puts C++26 reflection in front of a lot of people who will not go looking for it.
...
## LLVM 23.1, still at rc2

The 23.x branch was cut on 14 July, with rc1 on 23 July and **rc2 on 28 July**. No final release yet, so late August is the realistic date.
