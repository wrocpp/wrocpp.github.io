...
<GodboltEmbed id="abWecWbMn" compilerLabel="clang (trunk)" title="RTSan catches the malloc hiding inside a push_back" gcc_subtitle="x86-64 clang (trunk) · -fsanitize=realtime · runs live" />
