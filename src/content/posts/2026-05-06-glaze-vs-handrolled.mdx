...
On 28 April 2026 Stephen Berry [announced Glaze v7.2](https://stephenberry.github.io/glaze/p2996-reflection/). It is the first release whose reflection backend is **standard C++26**, not `__PRETTY_FUNCTION__` string-scraping.
...
The good news in 2026: **both** answers are cheap. Reflection retired the macro tax on every JSON library at once. It made the thirty-line teaching version a real artefact you can ship.
