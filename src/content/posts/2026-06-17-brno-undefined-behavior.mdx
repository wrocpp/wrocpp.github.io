...
**P3596R3, "Undefined Behavior and IFNDR Annexes"** (Berne, Doumler, Maurer, Yaghmour) adds two new annexes to the standard. One catalogues every case of **undefined behavior** (UB). The other catalogues every **ill-formed, no diagnostic required** (IFNDR) case -- the corners where your program is wrong but no compiler is obligated to tell you.
