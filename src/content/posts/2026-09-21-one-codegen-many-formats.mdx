...
draft: false
discussion: https://github.com/wrocpp/wrocpp.github.io/discussions/52
---
...
|---|---|---|---|
| JSON | none | braces + commas + quoted keys | `std::string` |
...
## Arc 4: CLI parsing, ORM, and dependency injection
